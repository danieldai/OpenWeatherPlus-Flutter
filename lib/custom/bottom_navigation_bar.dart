...
enum MyBottomNavigationBarType {
  /// The [MyBottomNavigationBar]'s [MyBottomNavigationBarItem]s have fixed width, always
...
///     return Scaffold(
///       appBar: AppBar(
///         title: Text('MyBottomNavigationBar Sample'),
///       ),
///       body: Center(
...
///           MyBottomNavigationBarItem(icon: Icon(Icons.home), title: Text('Home')),
///           MyBottomNavigationBarItem(icon: Icon(Icons.business), title: Text('Business')),
///           MyBottomNavigationBarItem(icon: Icon(Icons.school), title: Text('School')),
///         ],
...
class MyBottomNavigationBar extends StatefulWidget {
  ...
  /// is provided as the [Scaffold.MyBottomNavigationBar] argument.
  ///
  ...
  /// [ThemeData.primaryColor], is used. However if [MyBottomNavigationBar.type] is
    ...
    return Semantics(
      ...
      child: Material(
        ...
        child: ConstrainedBox(
          constraints: BoxConstraints(minHeight: _kBottomNavigationBarHeight + additionalBottomPadding),
          child: CustomPaint(
